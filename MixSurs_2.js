...
Object.defineProperty(Lampa.Api.sources, 'MIXMOVIE', {
get: function() {
return tmdb_mod;
}
});

Object.defineProperty(Lampa.Api.sources, 'KIDMOVIE', {
get: function() {
return tmdb_mod_kids;
}
});
Object.defineProperty(Lampa.Api.sources, 'RUMOVIE', {
get: function() {
return tmdb_mod_rus;
}
});
...
if (event.params.rus) {
changeSource('RUMOVIE', true);
} else {
changeSource('MIXMOVIE', true);
}
} else {
changeSource('KIDMOVIE', true);
}
});
...
if (event.value === 'MIXMOVIE' || event.value === 'KIDMOVIE' || event.value === 'RUMOVIE') {
